        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                CreditCounsel provides the following services:
              </p>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                By using CreditCounsel, you agree to:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>Provide accurate and truthful information when using our services</li>
                <li>Only dispute items on your credit report that you believe to be inaccurate, incomplete, or unverifiable</li>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                CreditCounsel offers one-time payment packages with no recurring subscriptions:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              ...
              <p className="text-gray-700 leading-relaxed">
                <strong>Refund Policy:</strong> We offer a 30-day money-back guarantee. If you're not satisfied with our service, contact us within 30 days of purchase for a full refund. Refunds are not available after dispute letters have been mailed to credit bureaus.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                All content, software, algorithms, and materials provided through CreditCounsel are protected by copyright, trademark, and other intellectual property laws. You may not:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to indemnify and hold harmless CreditCounsel, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising from your use of the Service, your violation of these Terms, or your violation of any rights of another party.
              </p>
            </section>
