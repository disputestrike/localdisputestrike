  ...
  const successStories = [
    {
      ...
      accountsDeleted: 3,
      daysToResults: 2,
      testimonial: "I couldn't believe how fast CreditCounsel AI worked! Within just 2 days of mailing my dispute letters, I saw 3 negative accounts completely removed from my Equifax report. My score jumped 42 points, and I finally qualified for the mortgage I've been dreaming about. The AI-powered letters were professional, legally sound, and incredibly effective. This platform saved me thousands compared to traditional credit repair companies!",
    ...
    },
    {
      ...
      accountsDeleted: 5,
      daysToResults: 28,
      testimonial: "After years of struggling with bad credit, I finally found a solution that works. CreditCounsel AI generated dispute letters that got 5 negative accounts deleted across all three bureaus. My score increased 58 points in less than a month! The best part? I did it all myself for a fraction of what credit repair companies charge. Highly recommend!",
