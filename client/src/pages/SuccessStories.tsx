...
export default function SuccessStories() {
  ...
  const successStories = [
    ...
    },
    {
      ...
      accountsDeleted: 5,
      daysToResults: 28,
      testimonial: "After years of feeling powerless, DisputeStrike helped me challenge what I believed was inaccurate on my credit report. The empowerment is real - I went from feeling helpless to feeling like I'm in control of my financial future. The Dispute letters gave me the confidence to defend my rights under federal law.",
